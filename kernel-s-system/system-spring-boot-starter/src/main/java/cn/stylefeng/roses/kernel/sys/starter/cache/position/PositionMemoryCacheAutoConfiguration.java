...
import cn.stylefeng.roses.kernel.sys.modular.position.cache.PositionMemoryCache;
...
public class PositionMemoryCacheAutoConfiguration {

    /**
     * 职位名称的缓存
     *
     * @author fengshuonan
     * @since 2025/1/10 14:22
     */
    @Bean
    public CacheOperatorApi<String> positionNameCache() {
